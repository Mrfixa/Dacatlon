  ...
  Widget build(BuildContext context) {
    return GetBuilder<ProfileController>(
      ...
      builder: (profileController) {
        // Read the same source the online/offline toggle writes to, and avoid
        // force-unwrapping profileInfo (fetched asynchronously in initState).
        log("=online==>${profileController.isOnline}");
        bool isOnline = profileController.isOnline == "1";
