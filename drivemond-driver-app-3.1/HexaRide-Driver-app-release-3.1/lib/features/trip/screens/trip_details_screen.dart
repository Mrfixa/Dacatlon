      ...
      child: CustomPopScopeWidget(
        child: Scaffold(
          body: GetBuilder<RideController>(builder: (rideController) {
            ...
            // Only render once the loaded detail is for THIS trip; the shared
            // tripDetail may still hold a previously-opened trip while this one
            // is being fetched, which would otherwise flash the wrong data.
            return (rideController.tripDetail != null && rideController.tripDetail!.id == widget.tripId) ?
            Column(children: [
